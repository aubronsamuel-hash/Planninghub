...
| docs/specs/ports/conflict_ports.md | Conflict ports shapes | tests/test_persistence_adapter_in_memory.py; tests/vertical_slices/test_application_vertical_slice.py | PARTIALLY COVERED | Detect and list conflicts exercised via adapter tests. |
